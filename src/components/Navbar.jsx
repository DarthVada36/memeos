    ...
    <header>
      <nav class="bg-primary p-4 fixed w-full top-0 z-10">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
          <a href="#" class="text-bronze text-2xl font-bold">
            Meme
          </a>
          <ul class="flex space-x-6">
            <li>
              <a
                href="#home"
                class="text-gray hover:bg-secondary hover:text-milk px-4 py-2 rounded"
              >
                Home
              </a>
            </li>
            ...
            <a
              href="/"
              class="text-gray transition-colors duration-300 transform dark:text-gray-200  border-blue-500 mx-1.5 sm:mx-6"
            >
              <img
                class="h-6 "
