...
const Footer = () => {
  return (
    <footer className="h-[120px] opacity-60 bg-primary flex justify-center items-center">
        <div className="flex flex-col items-center">
          ...
          <p className="w-[17.5em] text-center text-bronze text-[14px] font-normal font-[bodoni] leading-none">Copyright © 2024 MemeOS Inc. <br/>Todos los derechos reservados</p>
        </div>
    </footer>
  )
}
